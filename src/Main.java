...
private static String chooseFile() {
    ...
    var name = JOptionPane.showOptionDialog(null, "Vyber soubor:", "Výběr čteného souboru", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, null);
